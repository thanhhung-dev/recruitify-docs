...
import { Form, Input, Button, Row, Col, Typography, Divider, Space, Checkbox } from 'antd';
...
function Forget_Password() {
    ...
    return (
        <div style={{ width: '100%', height: '100vh', background: '#ffffff', margin: '0 auto', position: 'relative' }}>
            <Row style={{ height: '100vh', position: 'relative', overflow: 'hidden' }}>
                ...
                >
                    <Button
                        type="text"
                        icon={<LeftOutlined />}
                        style={{ padding: 0, marginBottom: '20px', color: '#666', alignSelf: 'flex-start', height: 'auto' }}
                    >
                        Back to home
                    </Button>

                    <div style={{ flex: 1, display: 'flex', justifyContent: 'center', alignItems: 'flex-start', marginTop: '100px' }}>
                        <div style={{ width: '100%', maxWidth: 380 }}>
                            ...
                            <div style={{ marginBottom: 32 }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    ...
                                    <span style={{ fontSize: '20px', fontWeight: 700, color: '#000', letterSpacing: '-0.5px' }}>RecruitJob</span>
                                </div>
                            </div>

                            <Title level={3} style={{ marginBottom: 12, fontWeight: 600 }}>Forget Password</Title>
                            <Text
                                type="secondary"
                                style={{ fontSize: '14px', display: 'block', marginBottom: 8 }}
                            >
                                Go to back{' '}
                                <a href="#" style={{ fontWeight: 500, color: '#000' }}>Sign In</a>
                            </Text>
                            <Text
                                type="secondary"
                            ...
                            >
                                ...
                                >
                                    <Input placeholder="Email address" size="large" style={{ borderRadius: '6px', height: 40 }} />
                                </Form.Item>
                ...
                {/* Right illustration / stats column */}
                <Col
                    span={12}
                    style={{
                        display: 'flex',
                ...
                >
                    {/* Background pattern (placeholder - could swap to image) */}
                    <div
                        style={{
                            position: 'absolute',
                            inset: 0,
                            backgroundImage: "url('/assets/caro.jpg')",
                                    ...
                                    {statsData.map((stat, index) => (
                                        <Col key={index} span={8} style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                                            {index === 0 ? (
                                                ...
                                                <img
                                                    src="/file.svg"
                                                    style={{ width: 20, height: 20, marginBottom: 12, filter: 'brightness(0) invert(1)' }}
                                                    alt=""
                                                />
                                            )}
                                            <Text style={{
